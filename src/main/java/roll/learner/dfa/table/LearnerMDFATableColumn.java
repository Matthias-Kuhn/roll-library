...
public class LearnerMDFATableColumn extends LearnerMDFATable {

    public LearnerMDFATableColumn(Options options, Alphabet alphabet, MembershipOracle<HashableValue> membershipOracle) {
